...
class CorePointDescSet : public std::vector<CorePointDesc>
{
  public:
	...
	inline const std::vector<float>& scales() const
	{
		return m_scales;
	}
	...
	**/
	...
	inline const unsigned descriptorID() const
	{
		return m_descriptorID;
	}
	//! Sets associated descriptor ID
	inline void setDescriptorID(unsigned ID)
	{
		m_descriptorID = ID;
	}

	//! Returns the number of dimensions per scale
	inline const unsigned dimPerScale() const
	{
		return m_dimPerScale;
	}
	//! Sets associated descriptor ID
	inline void setDimPerScale(unsigned dim)
	{
		m_dimPerScale = dim;
	}
