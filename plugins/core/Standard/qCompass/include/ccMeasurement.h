...
class ccMeasurement
{
  public:
	...
	// drawing stuff
	void setDefaultColor(const ccColor::Rgb& col)
	{
		m_normal_colour = col;
	}
	void setHighlightColor(const ccColor::Rgb& col)
	{
		m_highlight_colour = col;
	}
	void setActiveColor(const ccColor::Rgb& col)
	{
		m_active_colour = col;
	}
	void setAlternateColor(const ccColor::Rgb& col)
	{
	...
	{
		m_isHighlighted = isActive;
	}
	void setAlternate(bool isActive)
	{
		m_isAlternate = isActive;
	}
	void setNormal()
	{
		m_isActive      = false;
